...
SELECT listings.property_type, COUNT(reviews.id), date_reviewed FROM reviews GROUP BY listings.property_type INNER JOIN listings ON listings.id = reviews.listing_id;
